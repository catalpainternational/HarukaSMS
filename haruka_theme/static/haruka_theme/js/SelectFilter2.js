...
var SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_media_prefix) {
        ...
        var search_selector_img = quickElement('img', search_filter_label, '', 'src', admin_media_prefix + '../haruka_theme/images/admin/selector-search.png');
        ...
        quickElement('img', selector_filter, '', 'src', admin_media_prefix + (is_stacked ? '../haruka_theme/images/admin/selector_stacked-add.png':'../haruka_theme/images/admin/selector-add.png'), 'alt', 'Add');
